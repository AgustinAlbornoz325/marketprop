...
app = FastAPI(title="MarketProp API", version="0.3.10.1 Client Admin Separation")
...
@app.get("/")
def root():
    return {"app": "MarketProp", "version": "0.3.10.1 Client Admin Separation", "status": "running"}
